...
public class Sparbuch extends Konto {
	...
	public void waehrungswechsel(Waehrung neu) {
		if (this.getAktuelleWaehrung() == Waehrung.EUR)
			this.bereitsAbgehoben = neu.euroInWaehrungUmrechnen(this.bereitsAbgehoben);
		else if (neu == Waehrung.EUR)
			this.bereitsAbgehoben = this.getAktuelleWaehrung().waehrungInEuroUmrechnen(this.bereitsAbgehoben);
		else 
			this.bereitsAbgehoben = this.getAktuelleWaehrung().waehrungenUmrechnen(neu, this.bereitsAbgehoben);
